...
class Macros extends MacroSet
{
	...
	{
		return $writer->write('if($presenter->context->getByType("IPub\Security\Access\LatteChecker")->isAllowed(%node.array)){');
	}
	...
	public static function macroIfAllowedLink(MacroNode $node, PhpWriter $writer)
	{
		...
		return $writer->write('if($presenter->context->getByType("IPub\Security\Access\LinkChecker")->isAllowed(%node.word)){');
	}
